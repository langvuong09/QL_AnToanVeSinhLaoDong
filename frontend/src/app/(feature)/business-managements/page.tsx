...
function mapDoetUserToEnterprise(item: IDoetUser): Enterprise {
  ...
  return {
    ...
    gpkdProvince: doet.province?.value || '',
    gpkdProvinceData: doet.province || { key: 0, value: '' },
    gpkdWard: doet.ward?.value || '',
    gpkdWardData: doet.ward || { key: 0, value: '' },
    address: doet.address || '',
    businessProvince: doet.province?.value || '',
    businessProvinceData: doet.province || { key: 0, value: '' },
    businessWard: doet.ward?.value || '',
    businessWardData: doet.ward || { key: 0, value: '' },
    businessAddress: doet.address || '',
