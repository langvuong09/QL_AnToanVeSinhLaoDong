...
import { SubmitForm } from "../../../tnld-theo-hdld/_types/type";
...
const TNLDTheoHDLDAdminViewIdPage = () => {
    ...
    if (!id) {
        router.push("/tnld-theo-hdld-admin");
    }
    ...
    return (
        <main className="flex flex-col min-h-screen pb-10">
            ...
            <TopHero
                ...
                actions={
                    <div className="flex gap-5 items-center text-xs font-semibold">
                        <button className="text-gray-400" onClick={() => router.push("/tnld-theo-hdld-admin")}>Hủy bỏ</button>
            ...
            <div className="bg-white rounded-lg border border-gray-100 shadow-sm flex flex-col flex-1 min-h-0 overflow-hidden mt-5 px-5 py-5">
...
export default TNLDTheoHDLDAdminViewIdPage;