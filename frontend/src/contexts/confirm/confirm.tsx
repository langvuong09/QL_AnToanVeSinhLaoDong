...
const ConfirmProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <ConfirmContext.Provider value={{ waitConfirm }}>
            {modal && (
                <div className="fixed top-0 z-100 inset-s-0 bg-gray-800/60 w-full h-screen flex items-center justify-center px-2 md:px-0">
